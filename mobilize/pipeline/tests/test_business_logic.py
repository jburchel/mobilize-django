...
from mobilize.pipeline.models import (
    ...
    PIPELINE_TYPE_PEOPLE, PIPELINE_TYPE_CHURCH, PIPELINE_TYPE_CUSTOM
)
...
class PipelineAutomationBusinessLogicTest(TestCase):
    ...
    def test_auto_move_days_logic(self):
        ...
        should_auto_move = (
            self.auto_stage.auto_move_days and 
            days_in_stage >= self.auto_stage.auto_move_days
        )
    ...
    def test_auto_reminder_logic(self):
        ...
        should_send_reminder = (
            self.auto_stage.auto_reminder and 
            days_in_stage > 0 and 
            days_in_stage % 3 == 0  # Send reminder every 3 days
        )
