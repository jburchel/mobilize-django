...
class OfficeModelTests(TestCase):
    ...
    def test_office_minimal_data(self):
        ...
        minimal_office = Office.objects.create(name="Minimal Office", code="MIN001")
    ...
    def test_office_settings_json(self):
        ...
        office = Office.objects.create(
            name="Settings Office", code="SET001", settings=settings_data
        )
...
class UserOfficeModelTests(TestCase):
    ...
    def setUp(self):
        ...
        self.admin_user = User.objects.create_user(
            username="adminuser", email="admin@example.com", role="office_admin"
        )
    ...
    def test_user_office_role_choices(self):
        ...
        for role in valid_roles:
            ...
            user_office = UserOffice.objects.create(
                user=user, office=self.office, role=role
            )
    ...
    def test_user_multiple_offices(self):
        ...
        office2 = Office.objects.create(name="Second Office", code="SEC001")
        ...
        user_office2 = UserOffice.objects.create(
            user=self.user, office=office2, role="office_admin"
        )
    ...
    def test_office_multiple_users(self):
        ...
        user2 = User.objects.create_user(
            username="user2", email="user2@example.com", role="standard_user"
        )
        ...
        user_office2 = UserOffice.objects.create(
            user=user2, office=self.office, role="office_admin"
        )
    ...
    def test_user_office_primary_setting(self):
        ...
        user_office = UserOffice.objects.create(
            user=self.user, office=self.office, role="standard_user", is_primary=True
        )
        ...
        office2 = Office.objects.create(name="Second Office", code="SEC002")

        user_office2 = UserOffice.objects.create(
            user=self.user, office=office2, role="standard_user", is_primary=True
        )
