...
class OfficeForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            "name": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "Enter office name"}
            ),
            "code": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "e.g., NYC, LA, CHI"}
            ),
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.instance and self.instance.pk and self.instance.settings:
            ...
            self.fields["allow_cross_office_access"].initial = settings.get(
                "allow_cross_office_access", False
            )
            self.fields["default_pipeline"].initial = settings.get(
                "default_pipeline", ""
            )
            self.fields["enable_notifications"].initial = settings.get(
                "enable_notifications", True
            )
            self.fields["auto_assign_contacts"].initial = settings.get(
                "auto_assign_contacts", False
            )
            self.fields["require_approval_for_deletions"].initial = settings.get(
                "require_approval_for_deletions", True
            )
            self.fields["enable_advanced_reporting"].initial = settings.get(
    ...
    def save(self, commit=True):
        ...
        settings = {
            "allow_cross_office_access": self.cleaned_data.get(
                "allow_cross_office_access", False
            ),
            ...
            "auto_assign_contacts": self.cleaned_data.get(
                "auto_assign_contacts", False
            ),
            "require_approval_for_deletions": self.cleaned_data.get(
                "require_approval_for_deletions", True
            ),
            "enable_advanced_reporting": self.cleaned_data.get(
                "enable_advanced_reporting", False
            ),
        }
