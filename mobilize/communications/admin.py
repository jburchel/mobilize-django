...
class EmailTemplateAdmin(admin.ModelAdmin):
    list_display = ('name', 'subject', 'category', 'is_html', 'is_active', 'created_by', 'updated_at')
...
class CommunicationAdmin(admin.ModelAdmin):
    list_display = ('id', 'subject', 'type', 'date', 'direction', 'get_person', 'get_church')
    ...
    fieldsets = (
        ('Communication Details', {
            'fields': ('subject', 'message', 'type', 'direction', 'date', 'date_sent')
        }),
        ('Related Records', {
            'fields': ('person', 'church', 'office')
        }),
        ('Email Information', {
            'fields': ('gmail_message_id', 'gmail_thread_id', 'email_status', 'sender'),
            'classes': ('collapse',),
        }),
        ('Assignment', {
        ...
        ('Google Calendar Integration', {
            'fields': ('google_calendar_event_id', 'google_meet_link', 'last_synced_at'),
            'classes': ('collapse',),
        }),
        ('Attachments', {
            'fields': ('attachments',),
