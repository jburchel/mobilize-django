...
class GoogleMeetService:
    ...
    def create_instant_meet_link(
        self, title: str = "Video Call", duration_minutes: int = 60
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            meet_link = None
            if (
                "conferenceData" in created_event
                and "entryPoints" in created_event["conferenceData"]
            ):
