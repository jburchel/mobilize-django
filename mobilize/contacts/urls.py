...
urlpatterns = [
    ...
    path(
        "api/list/", views.person_list_api, name="person_list_api"
    ...
    path(
        "google-sync/selective/",
        views.selective_google_import,
        name="selective_google_import",
    ),
    path("api/google-contacts/", views.google_contacts_api, name="google_contacts_api"),
    # Bulk operations
    path("bulk/delete/", views.bulk_delete, name="bulk_delete"),
    path(
        "bulk/update-priority/", views.bulk_update_priority, name="bulk_update_priority"
    ),
