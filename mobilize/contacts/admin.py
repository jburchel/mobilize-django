...
class ContactAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Notes", {"fields": ("notes", "initial_notes")}),
        (
            "Google Integration",
        ...
        ("Custom Data", {"fields": ("tags", "custom_fields")}),
        ("Conflict Management", {"fields": ("conflict_data", "has_conflict")}),
    )
...
class PersonAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Professional Details", {"fields": ("profession", "organization")}),
        ("Church Relationship", {"fields": ("primary_church", "church_role")}),
        (
            "Social Media",
            {
                "fields": (
        ...
        ("Integration", {"fields": ("google_contact_id",)}),
    )
