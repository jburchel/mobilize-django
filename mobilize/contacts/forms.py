...
class PersonForm(forms.ModelForm):
    ...
    preferred_contact_method = forms.ChoiceField(
        choices=CONTACT_METHOD_CHOICES, required=False, label="Preferred Contact Method"
    )
    ...
    def __init__(self, *args, **kwargs):
        ...
        if main_pipeline:
            ...
            stage_choices.extend(
                [
                    ...
                    for stage in main_pipeline.stages.all().order_by("order")
                ]
            )
        ...
        if self.instance and hasattr(self.instance, "contact"):
            ...
            self.fields["pipeline_stage"].initial = (
                current_stage.name if current_stage else None
            )
            ...
            if primary_membership:
                ...
                first_membership = self.instance.church_memberships.filter(
                    status="active"
                ).first()
            ...
            if self.instance.languages:
                if isinstance(self.instance.languages, list):
                    self.fields["languages"].initial = ", ".join(
        ...
        self.helper.layout = Layout(
            ...
            Div(
                HTML(
                    '<div class="card mb-4"><div class="card-header bg-primary text-white"><h5 class="mb-0"><i class="fas fa-user me-2"></i>Basic Information</h5></div><div class="card-body">'
                ),
                Row(
            ...
            Div(
                HTML(
                    '<div class="card mb-4"><div class="card-header bg-info text-white"><h5 class="mb-0"><i class="fas fa-heart me-2"></i>Personal Details</h5></div><div class="card-body">'
                ),
                Row(
            ...
            Div(
                HTML(
                    '<div class="card mb-4"><div class="card-header bg-warning text-dark"><h5 class="mb-0"><i class="fas fa-briefcase me-2"></i>Professional Information</h5></div><div class="card-body">'
                ),
                Row(
            ...
            Div(
                HTML(
                    '<div class="card mb-4"><div class="card-header bg-success text-white"><h5 class="mb-0"><i class="fas fa-globe me-2"></i>Mission & Service</h5></div><div class="card-body">'
                ),
                Row(
            ...
            Div(
                HTML(
                    '<div class="card mb-4"><div class="card-header bg-purple text-white"><h5 class="mb-0"><i class="fas fa-church me-2"></i>Church Relationship</h5></div><div class="card-body">'
                ),
                Row(
            ...
            Div(
                HTML(
                    '<div class="card mb-4"><div class="card-header bg-gradient text-white"><h5 class="mb-0"><i class="fas fa-share-alt me-2"></i>Social Media</h5></div><div class="card-body">'
                ),
                Row(
            ...
            Div(
                HTML(
                    '<div class="card mb-4"><div class="card-header bg-dark text-white"><h5 class="mb-0"><i class="fas fa-sticky-note me-2"></i>Notes & Tags</h5></div><div class="card-body">'
                ),
                "initial_notes",
                "notes",
                "tags",
            ...
            Div(
                Submit(
                    "submit", "Save Person", css_class="btn btn-primary btn-lg me-3"
                ),
                HTML(
                    "<a href=\"{% if person %}{% url 'contacts:person_detail' person.pk %}{% else %}{% url 'contacts:person_list' %}{% endif %}\" class=\"btn btn-secondary btn-lg\">Cancel</a>"
                ),
    ...
    def save(self, commit=True, user=None, office=None):
        ...
        contact.preferred_contact_method = self.cleaned_data.get(
        ...
        if commit:
            ...
            if languages_input:
                ...
                languages_list = [
                    lang.strip() for lang in languages_input.split(",") if lang.strip()
                ]
            ...
            if primary_church and church_role:
                ...
                ChurchMembership.objects.filter(
                    church=primary_church, is_primary_contact=True
                ...
                person.church_memberships.filter(is_primary_contact=True).update(
                    status="inactive"
                )
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            Div(
                ...
                HTML(
                    '<a href="{% url \'contacts:person_list\' %}" class="btn btn-secondary ms-2">Cancel</a>'
                ),
                css_class="mt-4",
            ),
        )
