...
class ContactModelTest(TestCase):
    ...
    def test_contact_from_supabase_conversion(self):
        ...
        self.assertEqual(
            django_dict["street_address"], self.supabase_data["street_address"]
        )
    ...
    def test_contact_create_from_supabase(self):
        ...
        self.assertEqual(
            new_contact.street_address, self.supabase_data["street_address"]
        )
    ...
    def test_contact_update_from_supabase(self):
        ...
        # Update the contact
        updated_contact = SupabaseMapper.update_from_supabase(
            self.contact, updated_data
        )
