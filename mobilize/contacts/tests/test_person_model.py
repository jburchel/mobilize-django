...
class PersonModelTest(TestCase):
    ...
    def test_person_from_supabase_conversion(self):
        ...
        self.assertEqual(django_dict['spouse_first_name'], self.supabase_data['spouse_first_name'])
        self.assertEqual(django_dict['spouse_last_name'], self.supabase_data['spouse_last_name'])
    ...
    def test_person_create_from_supabase(self):
        ...
        self.assertEqual(new_person.contact.first_name, self.supabase_data['first_name'])
