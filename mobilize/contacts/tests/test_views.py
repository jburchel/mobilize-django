...
class ContactViewTest(TestCase):
    ...
    def test_contact_detail_view(self):
        ...
        response = self.client.get(
            reverse("contacts:person_detail", args=[self.contact.id])
        )
        self.assertEqual(response.status_code, 200)
...
class PersonViewTest(TestCase):
    ...
    def test_person_detail_view(self):
        ...
        self.client.login(username="testuser", password="testpass123")
        response = self.client.get(
            reverse("contacts:person_detail", args=[self.person.contact_id])
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_person_edit_view_get(self):
        ...
        self.client.login(username="testuser", password="testpass123")
        response = self.client.get(
            reverse("contacts:person_edit", args=[self.person.contact_id])
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_person_edit_view_post(self):
        ...
        response = self.client.post(
            reverse("contacts:person_edit", args=[self.person.contact_id]), data
        )
    ...
    def test_person_delete_view_get(self):
        ...
        self.client.login(username="testuser", password="testpass123")
        response = self.client.get(
            reverse("contacts:person_delete", args=[self.person.contact_id])
        )
        self.assertEqual(response.status_code, 200)
