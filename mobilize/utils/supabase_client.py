...
class SupabaseClient:
    ...
    def fetch_all(
        self, model_class: Type[models.Model], limit: Optional[int] = None
    ) -> List[Dict[str, Any]]:
        """
        ...
        try:
            ...
            if hasattr(response, "data"):
                logger.info(
                    f"Successfully fetched {len(response.data)} records from {table_name}"
                )
    ...
    def fetch_by_id(
        self, model_class: Type[models.Model], record_id: Union[str, int]
    ...
    def insert(
        self, model_class: Type[models.Model], data: Dict[str, Any]
    ) -> Optional[Dict[str, Any]]:
        """
