...
class SupabaseClientTest(TestCase):
    ...
    def setUp(self):
        ...
        self.mock_response.data = [{'id': 1, 'name': 'Test Contact', 'email': 'test@example.com'}]
    ...
    @patch.dict(os.environ, {"SUPABASE_URL": "https://example.supabase.co", "SUPABASE_KEY": "test-key"})
