...
class SyncSupabaseCommandTest(TestCase):
    ...
    def test_dry_run(self):
        """Test dry run mode."""
        with patch('mobilize.utils.management.commands.sync_supabase.Command._sync_to_supabase'), \
             patch('mobilize.utils.management.commands.sync_supabase.Command._sync_from_supabase'):
    ...
    def test_sync_from_supabase(self):
        ...
        with patch('mobilize.utils.management.commands.sync_supabase.Command._sync_from_supabase') as mock_sync_method:
            # Call the command
            call_command(
                'sync_supabase',
