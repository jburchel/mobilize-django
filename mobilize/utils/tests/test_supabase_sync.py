...
class SupabaseSyncTestCase(TestCase):
    ...
    def test_bulk_sync_from_supabase(self, mock_sync_from_supabase):
        ...
        # Call the method
        result = SupabaseSync.bulk_sync_from_supabase(
            supabase_data_list, self.mock_model
        )
    ...
    def test_resolve_conflicts_django_strategy(self):
        ...
        conflicts = {
            "first_name": {"django_value": "John", "supabase_value": "Jane"},
            "email": {
    ...
    def test_resolve_conflicts_supabase_strategy(self):
        ...
        # Call the method
        result = SupabaseSync.resolve_conflicts(
            self.mock_instance, conflicts, "supabase"
        )
