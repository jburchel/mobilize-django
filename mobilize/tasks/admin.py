...
class TaskAdmin(admin.ModelAdmin):
    ...
    list_display = ('title', 'due_date', 'status', 'priority', 'assigned_to', 'is_recurring_template', 'is_completed')
    ...
    fieldsets = (
        ...
        ('Recurring Tasks', {
            'fields': ('is_recurring_template', 'recurring_pattern', 'recurrence_end_date', 'parent_task', 'next_occurrence_date'),
            'classes': ('collapse',)
        }),
        ('System', {
