...
class UserContactSyncSettingsForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ["sync_preference", "auto_sync_enabled", "sync_frequency_hours"]
        widgets = {
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            FormActions(
                ...
                HTML(
                    '<a href="{% url \'core:settings\' %}" class="btn btn-secondary">Cancel</a>'
                ),
            ),
        )
...
class ContactSyncPreferenceForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            FormActions(
                Submit(
                    "save_and_continue", "Save & Continue", css_class="btn btn-primary"
                ),
...
class CreateUserForm(forms.ModelForm):
    ...
    def clean_email(self):
        ...
        if email and not email.endswith("@crossoverglobal.net"):
            raise forms.ValidationError("Email must be a @crossoverglobal.net address")
