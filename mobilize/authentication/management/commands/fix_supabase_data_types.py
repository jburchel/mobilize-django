        ...
        with connection.cursor() as cursor:
                    ...
                    for column in columns:
                        ...
                        if result:
                            ...
                            if data_type == 'character varying':
                                self.stdout.write(f'  ⚠️  {column} is VARCHAR, needs to be INTEGER')
                                ...
                                try:
                                    ...
                                    self.stdout.write(f'  ✅ Converted {column} to INTEGER')
                                except Exception as e:
                                    self.stdout.write(self.style.ERROR(f'  ❌ Failed to convert {column}: {e}'))
                            else:
                                self.stdout.write(f'  ✅ {column} is already {data_type}')
            ...
            for table in office_tables:
                ...
                if result and result[0] == 'character varying':
                    self.stdout.write(f'  ⚠️  {table}.office_id is VARCHAR, needs to be INTEGER')
                    ...
                    try:
                        ...
                        self.stdout.write(f'  ✅ Converted {table}.office_id to INTEGER')
                    except Exception as e:
