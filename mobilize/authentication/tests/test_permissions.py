...
class PermissionSystemTests(TestCase):
    ...
    def setUp(self):
        ...
        self.regular_user = User.objects.create_user(
            username="user", email="user@example.com", role="standard_user"
        )
...
class RoleRequiredDecoratorTests(TestCase):
    ...
    def setUp(self):
        ...
        self.admin_user = User.objects.create_user(
            username="admin", email="admin@example.com", role="office_admin"
        )
    ...
    def test_role_hierarchy_enforcement(self):
        ...
        super_admin = User.objects.create_user(
            username="superadmin2", email="super2@example.com", role="super_admin"
        )

        office_admin = User.objects.create_user(
            username="officeadmin2", email="office2@example.com", role="office_admin"
        )
