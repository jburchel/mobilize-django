...
class ContactManagementE2ETests(TestCase):
    ...
    def test_complete_contact_lifecycle(self):
        ...
        response = self.client.post(reverse('communications:communication_create'), {
            'type': 'email',
        ...
        for i in range(1, len(self.stages)):
            ...
            # Complete the task
            task = Task.objects.filter(title=f'{self.stages[i].name} - Jane Smith').first()
...
class ChurchManagementE2ETests(TestCase):
    ...
    def test_church_creation_and_contact_association(self):
        ...
        response = self.client.post(reverse('churches:church_create'), {
...
class EmailCommunicationE2ETests(TestCase):
    ...
    def test_email_template_and_bulk_send_workflow(self):
        ...
        response = self.client.post(reverse('communications:email_template_create'), {
            'name': 'Welcome Email',
        ...
        for person in self.contacts:
            ...
            subject = template.subject.replace('{first_name}', person.contact.first_name)
