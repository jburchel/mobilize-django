...
class ResponseTimeOptimizationTest(TestCase):
    ...
    def test_dashboard_response_time(self):
        ...
        print(f"Dashboard loaded in {total_time:.4f} seconds with {query_count} queries")
    ...
    def test_contact_list_with_pagination(self):
        ...
        for page_size in page_sizes:
            ...
            self.assertLess(query_count, 15, f"Too many queries for page size {page_size}")
    ...
    def test_caching_effectiveness(self):
        ...
        print(f"First load (cache miss): {first_load_time:.4f}s, {first_query_count} queries")
        ...
        self.assertLess(cached_load_time, first_load_time * 0.7, "Cache not effective enough")
        self.assertLess(cached_query_count, first_query_count, "Cache should reduce queries")
    ...
    def test_database_connection_pooling(self):
        ...
        print(f"Request times - Avg: {avg_time:.4f}s, Min: {min_time:.4f}s, Max: {max_time:.4f}s")
        
        # Connection pooling should provide consistent performance
        variance = max_time - min_time
        self.assertLess(variance, 0.5, "High variance in request times - connection pooling issue?")
    ...
    def test_static_file_serving_performance(self):
        ...
        for static_url in static_urls:
            ...
            if response.status_code == 200:
                ...
                self.assertLess(load_time, 0.1, f"Static file {static_url} loads too slowly")