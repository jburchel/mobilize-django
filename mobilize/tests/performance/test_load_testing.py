...
class AdminUser(HttpUser):
    ...
    def generate_report(self):
        ...
        self.client.get(f"/reports/{report_type}/", name=f"{report_type.title()} Report")
...
class MobileUser(HttpUser):
    ...
    def add_quick_note(self):
        ...
        contact_id = random.randint(1, 50)
        self.client.post(f"/contacts/{contact_id}/note/", {
...
class StressTestUser(HttpUser):
    ...
    def concurrent_updates(self):
        ...
        self.client.post(f"/contacts/{contact_id}/update/", {
...
class APIUser(HttpUser):
    ...
    def api_update_contact(self):
        ...
        contact_id = random.randint(1, 50)
        self.client.put(f"/api/contacts/{contact_id}/", json={
            "notes": f"Updated via API at {random.random()}"
