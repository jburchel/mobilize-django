...
class ChurchViewTests(TestCase):
    ...
    def test_church_list_filter_by_pipeline(self):
        ...
        response = self.client.get(reverse('churches:church_list'), {'pipeline_stage': 'Active'})
        self.assertEqual(response.status_code, 200)
        self.assertContains(response, 'First Baptist Church')
        self.assertNotContains(response, 'Methodist Church')
    ...
    def test_church_list_filter_by_priority(self):
        ...
        response = self.client.get(reverse('churches:church_list'), {'priority': 'High'})
        self.assertEqual(response.status_code, 200)
        self.assertContains(response, 'First Baptist Church')
        self.assertNotContains(response, 'Methodist Church')
    ...
    def test_church_detail_view(self):
        ...
        response = self.client.get(reverse('churches:church_detail', kwargs={'pk': self.church1.pk}))
        self.assertEqual(response.status_code, 200)
        self.assertContains(response, 'First Baptist Church')
    ...
    def test_church_detail_view_nonexistent(self):
        ...
        response = self.client.get(reverse('churches:church_detail', kwargs={'pk': 99999}))
    ...
    def test_church_edit_view_get(self):
        ...
        response = self.client.get(reverse('churches:church_edit', kwargs={'pk': self.church1.pk}))
        self.assertEqual(response.status_code, 200)
        self.assertContains(response, 'First Baptist Church')
    ...
    def test_church_delete_view_get(self):
        ...
        response = self.client.get(reverse('churches:church_delete', kwargs={'pk': self.church1.pk}))
        self.assertEqual(response.status_code, 200)
    ...
    def test_church_delete_view_post(self):
        ...
        response = self.client.post(reverse('churches:church_delete', kwargs={'pk': church_id}))
    ...
    def test_church_contacts_view(self):
        ...
        response = self.client.get(reverse('churches:church_contacts', kwargs={'pk': self.church1.pk}))
        self.assertEqual(response.status_code, 200)
...
class ChurchImportExportViewTests(TestCase):
    ...
    def test_views_require_authentication(self):
        ...
        for view_name in view_names:
            ...
            self.assertIn('/login/', response.url, f"View {view_name} should redirect to login")
