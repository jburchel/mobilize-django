...
class ChurchFormTests(TestCase):
    ...
    def test_church_form_edit_existing(self):
        ...
        church = Church.objects.create(
            name="Original Church", location="Original Location", office_id=1
        )
...
class ImportChurchesFormTests(TestCase):
    ...
    def test_valid_csv_file(self):
        ...
        csv_file = SimpleUploadedFile(
            "churches.csv", csv_content, content_type="text/csv"
        )
    ...
    def test_invalid_file_extension(self):
        ...
        txt_file = SimpleUploadedFile(
            "churches.txt", txt_content, content_type="text/plain"
        )
    ...
    def test_large_file_handling(self):
        ...
        csv_file = SimpleUploadedFile(
            "large_churches.csv", csv_content, content_type="text/csv"
        )
