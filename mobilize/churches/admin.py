...
class ChurchAdmin(admin.ModelAdmin):
    list_display = (
        ...
        "name",
        "denomination",
        "get_contact_pipeline_stage",
        "get_contact_priority",
    )
    list_filter = (
        "denomination",
        "contact__office_id",
    )  # Filter by fields on Church or related Contact
    ...
    fieldsets = (
        ...
        (
            "Missions Pastor",
            {
                "fields": (
                    ...
                    "missions_pastor_phone",
                    "missions_pastor_email",
                )
            },
        ),
        (
        ...
        (
            "Status & Source",
            {  # Renamed section, removed pipeline/priority
                "fields": ("virtuous", "date_closed", "source", "referred_by")
            },
        ),
        ("Church-specific Notes", {"fields": ("info_given", "reason_closed")}),
    )
