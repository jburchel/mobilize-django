...
class ActivityLogModelValidationTests(TestCase):
    ...
    def test_activity_log_creation_with_required_fields(self):
        ...
        log = ActivityLog.objects.create(
            action_type="view", entity_type="person", entity_id=self.person.id
        )
    ...
    def test_activity_log_action_choices(self):
        ...
        for action in valid_actions:
            log = ActivityLog.objects.create(
                action_type=action, entity_type="test", entity_id=1
            )
    ...
    def test_activity_log_string_representation_without_user(self):
        ...
        log = ActivityLog.objects.create(action_type="sync", entity_type="system")
    ...
    def test_activity_log_string_representation_with_full_name(self):
        ...
        log = ActivityLog.objects.create(
            user=self.user, action_type="update", entity_type="contact"
        )
    ...
    def test_activity_log_ordering(self):
        ...
        log1 = ActivityLog.objects.create(action_type="create", entity_type="test1")

        log2 = ActivityLog.objects.create(action_type="create", entity_type="test2")
    ...
    def test_activity_log_foreign_key_constraints(self):
        ...
        log = ActivityLog.objects.create(
            user=self.user, office=self.office, action_type="test"
        )
    ...
    def test_activity_log_helper_method_with_content_object(self):
        ...
        log = ActivityLog.log_activity(
            user=self.user, action_type="view", content_object=self.person
        )
    ...
    def test_activity_log_ip_address_validation(self):
        ...
        # Valid IPv4
        log = ActivityLog.objects.create(action_type="test", ip_address="192.168.1.1")
        self.assertEqual(log.ip_address, "192.168.1.1")

        # Valid IPv6
        log = ActivityLog.objects.create(action_type="test", ip_address="2001:db8::1")
