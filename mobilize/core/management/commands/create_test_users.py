...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        with transaction.atomic():
            ...
            if not offices:
                self.stdout.write(self.style.ERROR('No offices found. Please run create_sample_data first.'))
                return
            ...
            user_names = [
                ...
                ('Chris', 'Miller'), ('Amy', 'Garcia'), ('Tom', 'Martinez'),
                ('Emma', 'Anderson'), ('Ryan', 'Taylor'), ('Kate', 'Thomas')
            ]
